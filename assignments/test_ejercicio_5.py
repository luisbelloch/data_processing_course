...
def test_ejercicio_5_existen_605_contenedores(spark_context, path_resultados, resultados):
...
def test_ejercicio_5_todos_los_contendores_invalidos_estan_excluidos(spark_context, path_resultados, resultados):
